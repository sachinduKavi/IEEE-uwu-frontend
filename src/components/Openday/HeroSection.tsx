      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            >
              <span className="block text-blue-200 text-lg sm:text-xl md:text-2xl">
                WELCOME TO
              </span>
              <motion.span
          ...
          >
            Join us for an exciting day of innovation, technology, and
            networking
          </motion.p>
          ...
          >
            {[
              ...
              },
              {
                ...
                text: "Technology Lecture Hall - 1",
              },
              {
