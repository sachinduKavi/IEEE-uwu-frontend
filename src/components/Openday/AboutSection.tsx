      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <motion.p
            ...
            variants={cardVariants}
          >
            IEEE Uva Wellassa University Student Branch is a passionate group of
            students dedicated to promoting technology and engineering.
            Affiliated with IEEE, the world's largest technical organization, we
            strive to advance innovation for the benefit of humanity.
          </motion.p>
          ...
          <motion.p
            ...
            variants={cardVariants}
          >
            Join us for the official welcome and induction of new members into
            the Student Branch, which is designed to offer participants a
            comprehensive introduction to the Institute of Electrical and
            Electronics Engineers (IEEE), including its global structure,
            available opportunities, insights into the professional and personal
            development avenues offered, and the transformative impact of
            volunteerism.
          </motion.p>

          {/* Video Section */}
          <motion.div className="mt-10 sm:mt-16" variants={cardVariants}>
