...
const InteractiveTechPanel = () => {
  ...
  const gameUrl =
    "https://drive.google.com/drive/folders/13JjbHm_tWQYHrSWjvSRb8SEQ82rt0Qy8?usp=sharing";
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 pb-10 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            >
              Join the ultimate test of your IEEE knowledge and technical
              expertise!
            </motion.p>
          </motion.div>
        </motion.div>
      ...
      {/* Main Content */}
      <div ref={ref} className="container mx-auto px-4 mt-5">
