...
export default function TeamSection() {
  ...
  const nextSlide = () => {
    setActiveIndex((prev) =>
      prev === departmentTeams.length - 1 ? 0 : prev + 1,
    );
  };

  const prevSlide = () => {
    setActiveIndex((prev) =>
      prev === 0 ? departmentTeams.length - 1 : prev - 1,
    );
  };
      ...
      <div className="container mx-auto px-4 ">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Meet the talented teams working behind the scenes to make this event
            a success.
          </motion.p>
        </motion.div>
              ...
              >
                ...
                <div className="w-full md:w-2/3 my-auto text-center md:text-left">
                  ...
                  <motion.p
                    ...
                    viewport={{ once: true }}
                  >
                    A motivated leader with a strong passion for technology and
                    education, Gihan Lahiru Bimsara spearheads the IEEE Open Day
                    initiative, fostering innovation and collaboration. His
                    leadership ensures the smooth execution of projects,
                    empowering participants and promoting technological
                    engagement.
                  </motion.p>
                </div>
              </motion.div>
            ...
            <div ref={sliderRef} className="overflow-hidden relative w-full">
              ...
              >
                {departmentTeams.map((team, index) => (
                  <div
                    key={index}
                    className="inline-block w-full px-4 max-sm:!-mt-[130px] lg-only:-mt-130px"
                  >
                                ...
                                .map((member, memberIndex) => (
                                  ...
                                  >
                                    ...
                                    <div className="text-center w-full">
                                      <h4 className="mx-auto font-semibold text-blue-900 text-sm ">
                                        {member.name}
                                      </h4>
                                      <p className="mx-auto text-blue-600 font-medium text-xs">
                                        {member.role}
                                      </p>
                                    </div>
                                  </div>
