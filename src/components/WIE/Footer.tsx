...
export default function WIEFooter() {
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="lg:col-span-1">
                        <Link to="/" className="flex mb-6">
                            ...
                            <div>
                                <h3 className="text-xl font-bold">IEEE WIE</h3>
                                <p className="text-purple-300 text-sm">Uva Wellassa University</p>
                            </div>
                        </Link>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-purple-300">Quick Links</h3>
                        <ul className="space-y-3">
                            ...
                            <li><a href="#committee" className="text-gray-300 hover:text-white transition-colors">Committee</a></li>
                    ...
                    {/* Events */}
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-purple-300">Upcoming Events</h3>
                        <ul className="space-y-4">
                            <li>
                                <a href="#" className="flex group">
                                    <div className="w-12 h-12 bg-purple-700 rounded-lg flex items-center justify-center mr-3 group-hover:bg-purple-600 transition-colors">
                                        <span className="text-sm font-bold">25</span>
                                    </div>
                                    <div>
                                        <p className="text-white font-medium group-hover:text-purple-300 transition-colors">SHECODERess Finals</p>
                                        <p className="text-sm text-gray-400">October 2023</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="#" className="flex group">
                                    ...
                                    <div>
                                        <p className="text-white font-medium group-hover:text-purple-300 transition-colors">Industry Workshop</p>
                                        <p className="text-sm text-gray-400">November 2023</p>
                                    </div>
                                </a>
                            </li>
                        </ul>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm mb-4 md:mb-0">
                        © {new Date().getFullYear()} IEEE WIE Uva Wellassa University. All rights reserved.
                    </p>
