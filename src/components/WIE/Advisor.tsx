            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className={`flex flex-col lg:flex-row gap-12 items-center transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    <div className="lg:w-3/5">
                        ...
                        {/* Quote */}
                        <div className="mt-8 bg-gradient-to-r from-purple-600 to-purple-800 rounded-2xl p-6 text-white shadow-lg">
                            <svg className="w-8 h-8 text-purple-200 mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
                            </svg>
                            <p className="text-lg italic">
                                "Empowering women in engineering isn't just about equality—it's about unlocking the full potential of innovation
                                and progress for the benefit of all humanity."
                            </p>
                        </div>
                    </div>
                </div>
