    ...
    >
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Have questions or want to learn more about our chapter? We'd love to hear from you!
        </motion.p>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          <div className="flex items-center gap-3 bg-yellow-100 p-4 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <a href="mailto:contact@ieeecs.edu" className="text-gray-800 font-medium hover:text-yellow-600 transition">
              contact@ieeecs.edu
            </a>
          </div>
