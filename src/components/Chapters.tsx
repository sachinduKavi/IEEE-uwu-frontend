  ...
  const chapters = [
    {
      ...
      acronym: "WIE",
      description:
        "Empowers women in engineering and fosters diversity and inclusion through events, mentorship, and advocacy.",
      image: WIEGroupImage,
    ...
    },
    {
      ...
      acronym: "RAS",
      description:
        "Dedicated to promoting innovation, education, and collaboration in robotics and automation technologies.",
      image: RASGroupImage,
    ...
    },
    {
      ...
      acronym: "IAS",
      description:
        "Focuses on advancing the theory and practice of electrical and electronic engineering in the development and application of industrial systems.",
      image: IASGroupImage,
...

    {
      ...
      acronym: "CS",
      description:
        "Engages students in computing technologies, software engineering, and emerging digital fields.",
      image: CSGroupImage,
    ...
    <section id="chapters" className="py-12 md:py-20 bg-white">
      <div className="w-[90%] max-w-7xl px-4 mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          ></div>
          <p
            className="text-lg md:text-xl mx-auto max-w-3xl leading-relaxed"
            style={{ color: colors.textLight }}
          >
            Explore our specialized IEEE chapters that focus on different areas
            ...
            >
              ...
              <CardFooter className="px-6 pb-6 pt-0">
                <Button
                  ...
                  className="w-full transition-all duration-300 hover:scale-[1.02] group-hover:shadow-md cursor-pointer"
                  style={{
                    backgroundColor: colors.primary,
                    color: "white",
                  }}
        ...
        <div className="mt-16 md:mt-20 text-center">
          ...
          >
            ...
            ></div>
            <div
              className="absolute right-20 top-1/2 w-16 h-16 rounded-full opacity-15"
              style={{ backgroundColor: colors.primary }}
            ></div>
            ...
            <div className="relative z-10">
              ...
              <p
                ...
                style={{ color: colors.textLight }}
              >
                Become a member of our IEEE Student Branch and unlock
                opportunities to grow, learn, and connect with professionals
                across all our specialized chapters.
              </p>
              <Button
